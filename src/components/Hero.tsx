import React from 'react';
   ...
   const Hero = () => {
     return (
       <section
         id="about"
         className="pt-32 pb-16 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800"
       >
           ...
           <div className="flex flex-col md:flex-row items-center gap-12">
             <div className="flex-1 space-y-8">
               ...
               <p className="text-lg text-gray-600 dark:text-gray-300">
                 Software Developer based in Lahore, Pakistan. Passionate about
               ...
               <div className="flex gap-4">
                 ...
                 <a
                   href="/assets/cv.pdf" // Path to your PDF in the public folder
                   download
                   className="flex items-center gap-2 bg-blue-600 dark:bg-blue-400 text-white dark:text-gray-900 px-6 py-3 rounded-lg hover:bg-blue-500 dark:hover:bg-blue-300 transition-colors"
                 >
                   {/* You can use an icon if you like, for example: */}
                   {/* <Download size={20} /> */}
                   Download CV
                 </a>
               </div>
